...
// Run `composer install` locally before executing the following code with `php SampleGetReport.php`
...
function getReport()
{
    ...
    try {
        ...
        $getReportRequest->setFilename($filename);
        
        // Call the GetReport API
        $response = $apiInstance->getReport($marketplace, $getReportRequest);
